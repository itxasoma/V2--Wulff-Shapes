...
#    make diagnose            list which files are found
...
#
#  CSV files are always saved in the directory where you run make.
# ===========================================================================

PYTHON   = python3
SCRIPT   = $(dir $(abspath $(lastword $(MAKEFILE_LIST))))wulff_surface_energies.py
ROOT     = .
METALS   = Cu Pd
...
help:
	...
	@echo ""
	@echo "  CSVs are always saved in the directory where you run make."
	@echo ""
